            ...
            <div className="w-full md:w-1/3 bg-white p-6 rounded-lg shadow">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="
                    w-full py-2 px-4 rounded-md shadow-sm text-sm font-medium text-white !bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 
                  "
                >
